...
class PostgresApplicationSmokeTest {
    ...
    void applicationStartsOnFlywayPostgresAndPersistsIdentityBackedEntities() {
        ...
        // tb_device_registration/tb_push_delivery (mobile/desktop push delivery).
        assertEquals(82L, jdbcTemplate.queryForObject("""
        ...
        assertEquals(1L, jdbcTemplate.queryForObject("""
                SELECT COUNT(*) FROM information_schema.tables
                WHERE table_schema='public' AND table_name='tb_psychology_skill_release'
                """, Long.class));
        assertEquals(1L, jdbcTemplate.queryForObject(
