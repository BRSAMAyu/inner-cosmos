...
public class PromptBuilder {
    ...
    public PromptBuilder withSystemBoundary() {
        ...
        systemBoundary =
            ...
            + "The user's latest sentence is the primary evidence for this turn. History, memories, portraits, mood signals, and planner guidance are fallible background: use only what is directly relevant, never let them override an explicit correction or change of subject.\n"
