...
/**
 * CP-41 vivo Push mainland vendor transport (大陆厂商推送). Vendor REST credentials come
 * with the per-vendor 渠道合同 (operator gate, config inner-cosmos.push.vivo.* / env INNER_COSMOS_PUSH_VIVO_SECRET); until they
 ...
 */
@Component
public class VivoPushGateway implements PushGateway {
    @Override public String transport() { return "VIVO"; }
